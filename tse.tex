...
\begin{figure}[htbp]
\centering
\includegraphics[clip, trim=2cm 9cm 2cm 12cm, scale=0.45]{graphs/scaling_time_svcs_qos.pdf}
...
\begin{figure}[htbp]
%		\begin{minipage}{0.4\linewidth}
			\includegraphics[clip, trim=2cm 16cm 8cm 4cm, scale=0.55]{graphs/1_4_7_9_mkts_per_qos.pdf}
			\caption{Markets increase per QoS\label{fig:mkt_per_qos}}		
\end{figure}
%		\hspace{0.9cm}
%		\begin{minipage}{0.4\linewidth}
\begin{figure}
			\includegraphics[clip, trim=2cm 16cm 6cm 4cm, scale=0.55]{graphs/2_4_6_qos_per_mkt_scaling.pdf}
