...
%\begin{figure}
%\includegraphics[scale=0.31]{ orderbook.eps}
...
%\begin{figure}
%\includegraphics[scale=0.31]{ orderbook-after-one-pass.eps}
...
%\begin{figure}[H]
%\centering
%\includegraphics[scale=0.4]{ Agent_Package_Diagram.eps}
...
%\begin{figure}[ht]
%	\centering
%	\includegraphics[trim = 30mm 50mm 50mm 30mm, clip, scale=0.4]{ class_and_package_diagram.eps}
%	\label{class_diagram}
...
%\begin{figure*}[htbp]
%\centering
%\includegraphics[scale=0.46]{ Agent_Component_Diagram.eps}
...
%\begin{figure*}[htbp]
%\centering
%\includegraphics[scale=0.45]{ Agent_Class_Diagram.eps}
...
% \small Uniform Dist of QoS in Buyers & \includegraphics[scale=0.34] { uniform-seller-uniform-buyer.eps} & \includegraphics[scale=0.34] { uniform-seller-skewed-buyer.eps}\\ \hline
% \small Skewed Dist of QoS in Buyers & \includegraphics[scale=0.34] { uniform-seller-skewed-buyer.eps} & \includegraphics[scale=0.34] { skewed-seller-skewed-buyer.eps} \\ \hline 
% \end{tabular}
...
%       \begin{figure}
%	 \includegraphics[width=3.8in]{ probabilistic-change-to-qa.eps}
...
%       \end{figure}
%	 \begin{figure}
%	 \includegraphics[width=3.8in]{ periodic-change-to-qa.eps}
...
\end{figure*}
%\begin{figure}
%\includegraphics[scale=0.7]{figures/chapter4/distribute_budget.eps}
%\end{figure}
